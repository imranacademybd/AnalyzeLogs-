...
export default function GooglebotAnalyzerLayout() {
  ...
  const analyzeText = (text) => {
    ...
    lines.forEach(line => {
      ...
      if(data.bot.toLowerCase().includes('mobile')) newSummary.mobile++; 
      else newSummary.desktop++;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 shadow-md flex justify-between items-center">
        <h1 className="text-2xl font-bold">Alokito Googlebot Analyzer</h1>
      ...
      <section id="home" className="bg-gray-50 flex flex-col items-center justify-center text-center p-12">
        ...
        <button onClick={() => fileInputRef.current && fileInputRef.current.click()} className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:scale-105 transition mb-4">Upload & Analyze Now</button>
    ...
    <section className="additional-content py-16 px-6 md:px-12 bg-gradient-to-b from-gray-50 to-white border-t border-gray-200">
      ...
      <footer className="bg-gray-800 text-white p-6 mt-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <p>© 2025 Alokito Prithibi. All rights reserved.</p>
